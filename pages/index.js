      ...
      <div className={styles.mainSection}>
        ...
        <div className={styles.eventInfoWrapper}>
          ...
          <div className={styles.eventInfoGuests}>
            ...
            <span className={styles.guestsList}>
              Дорогой наш и почти уважаемый друг!!!
              В преддверии вашей будущей свадьбы и окончания холостой жизни,приглашаем вас,отметить последние дни жизни без печати в паспорте со своими пацанами.
              Если Вы, хотите отметить свой мальчишник, вас необходимо явиться в 27 июля в 15:30 в город Колпино, Бульвар трудящихся д.15 корп.3, там вас будет ожидать машина.
              Если же нет,то придется нам прибухнуть без тебя,но все тосты будут в твою честь..
            </span>
          </div>
        </div>
